...
class TestDiagramCommon(TestBase):
    ...
    def testPointLeftOfDiamond(self):
        ...
        actualAns:    bool = Common.pointInsidePolygon(pos=notInPolygon, polygon=self.diamond)
    ...
    def testInCenterOfDiamond(self):
        ...
        actualAns: bool = Common.pointInsidePolygon(pos=inPolygon, polygon=self.diamond)
    ...
    def testPointLeftOfArrow(self):
        ...
        notInPolygon: InternalPosition = InternalPosition(0.0, 0.0)
        actualAns:    bool = Common.pointInsidePolygon(pos=notInPolygon, polygon=self.arrow)
    ...
    def testInCenterOfArrow(self):
        ...
        actualAns: bool = Common.pointInsidePolygon(pos=inPolygon, polygon=self.arrow)
    ...
    def testBuildScanPointsForArrow(self):
        ...
        scanPoints: ScanPoints = Common.buildScanPoints(points=self.arrow)
    ...
    def testBuildScanPointsForDiamond(self):
        ...
        scanPoints: ScanPoints = Common.buildScanPoints(points=self.diamond)
